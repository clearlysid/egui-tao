...
impl WindowSettings {
    pub fn from_window(egui_zoom_factor: f32, window: &tao::window::Window) -> Self {
    ...
    pub fn initialize_viewport_builder<T>(
        &self,
    ...
    pub fn initialize_window(&self, window: &tao::window::Window) {
